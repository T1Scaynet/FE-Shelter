  ...
  return (
    <footer className='bg-[#511cbb3a] w-[100vw] h-[17rem] flex items-center justify-center fixed bottom-0 '>
      <div className='absolute w-[100%] h-[90%]'>
        ...
        <div className='absolute bottom-0 right-0 mr-[1.5rem]'>
          <img src={pet} alt='cat' className='h-[10rem]' />
        </div>
      </div>
      <div className='flex flex-row justify-between w-[90%] h-[90%] bg-[#7f818200] p-[0.4rem] relative'>
        ...
        <div className='flex flex-col mt-[2rem] w-[13rem]'>
          ...
          <div className='flex justify-center items-center flex-row mt-[1.4rem] bg-[#FFFFFF] h-[7rem] w-[100%]'>
            ...
            <div className='flex flex-col ml-[1.8rem] mt-[0.2rem]'>
              <b>7am - 6pm</b>
              <b>9am - 4pm</b>
              <b className='mt-[0.2rem] text-[#FF47A2]'>Cerrdo</b>
            </div>
          </div>
        </div>
        <div className='flex flex-col mt-[2rem] w-[25rem] bg-[#8b0d0d00]'>
          <b>Newsletter</b>
