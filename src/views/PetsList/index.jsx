...
export const PetsList = () => {
  ...
  const isActive = (selectedType, x) => {
    return filters[selectedType] === x
      ? 'bg-[#FFDA47] border-[#FFDA47] text-[#0e081e]'
      : 'border-[#7C58D3]';
  };
          ...
          <div className='w-[12rem] h-[30.7rem] border-[1px] border-[#EBE5F7] rounded-md text-center flex flex-col justify-center items-center sticky top-8'>
            ...
            <div>
              ...
              <span className='flex justify-center space-x-4'>
                <button
                  onClick={(e) => handleFilter(e, 'genre')}
                  value='Macho'
                  className={`h-8 w-16 border-2 border-[#7C58D3] rounded-md hover:bg-[#FFDA47] hover:border-none hover:text-[white] ${isActive(
                    'genre',
                    'Macho'
                  )}`}
                >
                ...
                <button
                  onClick={(e) => handleFilter(e, 'genre')}
                  value='Hembra'
                  className={`h-8 w-20 border-2 border-[#7C58D3] rounded-md hover:bg-[#FFDA47] hover:border-none hover:text-[white] ${isActive(
                    'genre',
                    'Hembra'
                  )}`}
                >
            ...
            <div>
              ...
              <span className='space-x-2'>
                ...
                <button
                  onClick={(e) => handleFilter(e, 'size')}
                  value='Chico'
                  className={`h-8 w-20 border-2 mt-2 border-[#7C58D3] rounded-md hover:bg-[#FFDA47] hover:border-none hover:text-[white] ${isActive(
                    'size',
                    'Chico'
                  )}`}
                >
            ...
            <button
              ...
              className='bg-[#7C58D3] text-[white] w-32 h-8 rounded-md mt-4 hover:bg-[#FFDA47] hover:text-[#0E081E]'
            >
              Limpiar filtros
            </button>
          </div>
