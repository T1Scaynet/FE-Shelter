          ...
          <section className='grid grid-cols-1 lg:flex lg:flex-row lg:items-center lg:space-x-10 lg:mt-[0.9rem]'>
            ...
            <div className='flex flex-col items-start w-[20.938rem]'>
              ...
              <div className='text-[1.625rem] font-bold flex flex-col justify-center text-left'>
                ...
                <div onClick={handleClick} className='rounded-[0.5rem] h-[4.375rem] w-[11.625rem] bg-[#7C58D3] hover:bg-[#5930b9] flex justify-center items-center mt-[3rem] ml-[3.125rem] text-[#FFFEFD] text-[1.5rem] font-extrabold transition-colors duration-500 hover:cursor-pointer'>
                  <img
                    src={fingerprint}
                    alt='fingerprint'
